...
var ABC = multiply(aTimesB,c)[0];
return [aPlusBplusC,ABC, a+ " and " +b+" and " +c+ " sum to " +aPlusBplusC+ '.','The product of '+a+' and '+b+' and '+c+' is ' +ABC+ '.'];
...
function sumArray(arrayToBeAdded) { //eslint-disable-line

    var sumOld=0
    for(var i=0; i< arrayToBeAdded.length; i++)
    {
        sumOld=sum(sumOld,arrayToBeAdded[i])[0]
    }
    var sumArrayOutput= [sumOld, arrayToBeAdded + " was passed in as an array of numbers, and "+sumOld+" is their sum."];
...
// Write your code here
function multiplyArray(ArrayToBeMultiplied) { //eslint-disable-line
    var totalProduct=1
    for(var i=0; i < ArrayToBeMultiplied.length; i++)
    {
        totalProduct=totalProduct*ArrayToBeMultiplied[i]
        var multiplyArrayOutput = [totalProduct, "The numbers " +ArrayToBeMultiplied+ " have a product of "+ totalProduct+ '.'];
    }
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
        ...
        for(var i=0; i < dynamicArray.length; i++)
        {
            ...
            var multiplyArrayOutput = [totalProduct, "The numbers " +dynamicArray+ " have a product of "+ totalProduct+ '.'];
        }
        return  multiplyArrayOutput;
    }
